    ...
    <header>
        <nav>
            ...
            <ul>
                ...
                <li><a href="<%= request.getContextPath()%>/movies "style=" text-decoration: underline;">Movies</a></li>
            </ul>
        ...
        <div class="Movie-list-con">
            <table>
            	...
            	<tbody>
            		<c:forEach var="data" items="${listMovies}">
                        <tr>
                           <td><c:out value="${data.id}"/> </td>
                           <td><c:out value="${data.title}"/> </td>
                           <td><c:out value="${data.year}"/> </td>
<%--                            <td><a class="action-buttton" href="edit?id=<c:out value='${data.id}' />">Edit</a> --%>
<!--                                &nbsp;&nbsp;&nbsp;&nbsp; <a class="action-buttton" -->
<%--                                 href="deleteEmployees?id=<c:out value='${data.id}' />">Delete</a> </td> --%>
<!--                         </tr> -->
                   </c:forEach>
